...
April saw a decline in xBZZ-denominated rewards, however it must be understood in light of the near 100% increase in the [fiat price of BZZ](https://coinmarketcap.com/currencies/ethereum-swarm/). Although rewards in xBZZ decreased, the real-world value distributed to node operators may have remained steady and likely increased for many. 
...
Total network rewards dropped to 24,441 xBZZ in April, down 38.7% from March’s 39,853 xBZZ. This is the lowest monthly total since February.
